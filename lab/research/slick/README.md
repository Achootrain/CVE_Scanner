...
- `dataset_dev.jsonl`: 35 records, 35 unique hosts (from 258 dev records)
- `dataset_test.jsonl`: 8 records, 8 unique hosts (from 82 test records)
...
5. Import rules to lab.db:
   ```bash
   python -m lab.research_cycle import-rules slick --rules-json lab/research/slick/rules_src.json
   ```
